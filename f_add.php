<?php 
	...
	{
		$insert_query="INSERT INTO faculty(f_name, f_code, f_dept, f_email, f_passw)
					   
					   VALUES('".$_POST['fname'].' '.$_POST['lname']."','".$_POST['code']."', '".$_POST['dept']."', '".
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            ...
            <p class="lead">You are now a registered faculty. 
            </p>
            <p class="lead">
